...
Vue.component('setting', __webpack_require__(219));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-80f4a7bc", Component.options)
  } else {
    hotAPI.reload("data-v-80f4a7bc", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        get_profile: function get_profile() {
            ...
            axios.get("/api/nguoi-dung/" + this.idUser).then(function (res) {
                _this.user = res.data;
                _this.user.password = "";
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("div", { staticClass: "col-sm-10" }, [
          _c("input", {
            ...
            attrs: { type: "text", id: "inputName", placeholder: "Họ" },
            domProps: { value: _vm.user.ho },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.user, "ho", $event.target.value)
              }
            }
          })
        ])
      ...
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("div", { staticClass: "col-sm-10" }, [
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { type: "text", id: "inputEmail", placeholder: "Tên" },
            domProps: { value: _vm.user.ten },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.user, "ten", $event.target.value)
              }
            }
          })
        ])
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.user.dia_chi,
                expression: "user.dia_chi"
              }
            ],
            staticClass: "form-control",
            attrs: { type: "text", placeholder: "Địa chỉ" },
            domProps: { value: _vm.user.dia_chi },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.user, "dia_chi", $event.target.value)
              }
            }
          })
        ])
      ...
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("div", { staticClass: "col-sm-10" }, [
          _vm.user.auth == 0
            ? _c("input", {
                staticClass: "form-control",
                attrs: { type: "text", disabled: "", value: "Người dùng" }
              })
            : _c("input", {
                staticClass: "form-control",
                attrs: { type: "text", disabled: "", value: "Admin" }
              })
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-sm-10" }, [
          _vm.user.trang_thai == 1
            ? _c("input", {
                staticClass: "form-control",
                attrs: { type: "text", disabled: "", value: "Bình thường" }
              })
            : _c("input", {
                staticClass: "form-control",
                attrs: { type: "text", disabled: "", value: "Bị khóa" }
              })
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("div", { staticClass: "col-sm-10" }, [
          _c("input", {
            staticClass: "form-control",
            attrs: { type: "text", disabled: "", value: "Tài khoản" },
            domProps: { value: _vm.user.tai_khoan }
          })
        ])
      ]),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-80f4a7bc", module.exports)
  }
}
