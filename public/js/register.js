...
Vue.component('register', __webpack_require__(224));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        on_register: function on_register() {
            axios.post("/register", {
                ho: this.user.ho,
                ten: this.user.ten,
    ...
    [
      ...
      _c("div", { staticClass: "form-group has-feedback" }, [
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Địa chỉ", required: "" },
        ...
        _vm._v(" "),
        _c("span", {
          staticClass: "fa fa-location-arrow form-control-feedback"
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group has-feedback" }, [
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.user.tai_khoan,
              expression: "user.tai_khoan"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Tài khoản", required: "" },
          ...
          on: {
            input: function($event) {
              ...
              _vm.$set(_vm.user, "tai_khoan", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
