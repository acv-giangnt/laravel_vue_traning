...
Vue.component('form-login', __webpack_require__(214));
...
Component.options.__file = "resources\\assets\\js\\components\\formlogin.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-88baa544", Component.options)
  } else {
    hotAPI.reload("data-v-88baa544", Component.options)
  }
    ...
    [
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.login.tai_khoan,
              expression: "login.tai_khoan"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Tài khoản", required: "" },
          domProps: { value: _vm.login.tai_khoan },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.login, "tai_khoan", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
      ...
      _c("div", { staticClass: "form-group has-feedback" }, [
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { type: "password", placeholder: "Mật khẩu", required: "" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-88baa544", module.exports)
  }
}
